...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%         print(hf, '-dpng', 'temp_image\bbox');
%         bb = imread('temp_image\bbox.png');
...
%             zero_img = patch('vertices', x2d, 'faces', face, ...
%                 'FaceColor', [1,1,1], 'FaceAlpha', 0.2, 'EdgeColor', 'none');
%             imwrite(zero_img, 'zero_image.png');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%             print(patchdata, '-dpng', 'temp_image\patchprojection');
